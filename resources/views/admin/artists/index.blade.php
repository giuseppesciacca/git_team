...
<div class="container py-5">
    <h1>Artist</h1> <a name="" id="" class="btn btn-primary" href="{{ route('admin.artists.create') }}" role="button">Create</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="modal fade" id="modal-{{$artist->id}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
